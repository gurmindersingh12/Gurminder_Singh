const publications = [
  {
    ...
    journal: "<i>Theoretical and Applied Genetics <strong>(Under Review: Accepted with Minor Revisions)</strong></i>",
    year: 2025,
    citations: 0,
    url: "https://doi.org/10.21203/rs.3.rs-7585385/v1",
    abstract: "This publication is Under Review (Click on <i>View Publication</i> to read the current preprint)",
    citingPapers: []
  },  
  {
...
const conferences = [
  {
    ...
    year: 2025,
    url: "https://agronomy.unl.edu/bic-napia-speakers/#wednesday",
