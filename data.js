...
const conferences = [
  ...
  },
  {
    ...
    citations: 0,
    url: "",
    abstract: "The necrotrophic fungal pathogen Parastagonospora nodorum produces necrotrophic effectors (NEs) that target specific genes in wheat to cause the disease septoria nodorum blotch (SNB). The interaction between the NE SnTox5 and the wheat gene <i>Snn5</i> plays a significant role in the development of SNB. <i>Snn5</i> was previously mapped to the long arm of chromosome 4B. Here, we combined positional cloning, TILLING, and gene editing approaches to clone <i>Snn5</i>. <i>Snn5</i> encodes a protein with protein kinase and major sperm protein (PK-MSP) domains expressed in multiple tissues but primarily roots. Analysis of <i>Snn5</i>-disrupted mutants indicated that both major domains are essential for function. Through related genetic experiments, we identified a second SnTox5-sensitivity locus on the short arm of chromosome 2B. This gene has been delineated to an 8.54 cM interval corresponding to a candidate gene region spanning 9.6 Mb in Svevo RefSeq v 1.0 containing 232 genes, six of which are <i>PK-MSP-like</i> genes. Given the presence of multiple SnTox5 sensitivity genes, we propose that the original sensitivity gene mapped to chromosome 4B be termed <i>Snn5-B1</i> and the second sensitivity gene mapped to chromosome 2B be termed <i>Snn5-B2</i>. Genome-wide association studies on large panels of durum and common wheat indicated that <i>Snn5-B1</i> was predominant among common wheat accessions whereas <i>Snn5-B2</i> appeared to be relatively more frequent among durum lines. This research extends our knowledge of the Snn5-SnTox5 interaction and the wheat-P. nodorum system in general, and provides tools to aid in the development of SNB-resistant wheat via marker-assisted selection and gene editing.",
    citingPapers: []
  },
  {
  ...
  },
  {
    ...
    abstract: "The root-lesion nematode (RLN), Pratylenchus neglectus, is an important pathogen of wheat. Utilizing host resistance is the most economical and environment-friendly way to control this nematode. To date, no RLN- resistant commercial wheat cultivar has been reported, and sources of resistance in wheat are scarce. Previous studies have reported high levels of resistance in rye and triticale. Triticale is a hybrid of wheat and rye, and identifying RLN resistance genes in triticale would be the first step to utilizing triticale resistance in wheat. In this study, a triticale population consisting of 141 recombinant inbred lines (RILs) derived from a cross between Siskiyou (susceptible parent) and Villax St. Jose (moderately resistant parent) was evaluated for reaction to P. neglectus under greenhouse conditions. Our goal was to identify QTL (quantitative trait loci) associated with resistance to RLN. The population was genotyped using genotyping-by-sequencing (GBS) and SSR markers, and a high-density genetic linkage map was constructed covering all wheat and rye chromosomes. Single trait multiple-interval mapping analysis revealed the presence of a single QTL (LOD = 8.6) on rye chromosome 5R that accounted for approximately 24.6% of the total phenotypic variation. The identified QTL needs to be validated in different genetic backgrounds to confirm its stability. The PCR-based molecular markers associated with this QTL will be useful for fine-mapping and to better understand the genetics of RLN resistance. This work provides a foundation for the introgression of rye-derived P. neglectus resistance into wheat germplasm.",
    citingPapers: []
  },
  {
