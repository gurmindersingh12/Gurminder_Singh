...
const conferences = [
  ...
  },
  {
    ...
    citations: 0,
    url: "",
    abstract: "The necrotrophic fungal pathogen Parastagonospora nodorum produces necrotrophic effectors (NEs) that target specific genes in wheat to cause the disease septoria nodorum blotch (SNB). The interaction between the NE SnTox5 and the wheat gene Snn5 plays a significant role in the development of SNB. Snn5 was previously mapped to the long arm of chromosome 4B. Here, we combined positional cloning, TILLING, and gene editing approaches to clone Snn5. Snn5 encodes a protein with protein kinase and major sperm protein (PK-MSP) domains expressed in multiple tissues but primarily roots. Analysis of Snn5-disrupted mutants indicated that both major domains are essential for function. Through related genetic experiments, we identified a second SnTox5-sensitivity locus on the short arm of chromosome 2B. This gene has been delineated to an 8.54 cM interval corresponding to a candidate gene region spanning 9.6 Mb in Svevo RefSeq v 1.0 containing 232 genes, six of which are PK-MSP-like genes. Given the presence of multiple SnTox5 sensitivity genes, we propose that the original sensitivity gene mapped to chromosome 4B be termed Snn5-B1 and the second sensitivity gene mapped to chromosome 2B be termed Snn5-B2. Genome-wide association studies on large panels of durum and common wheat indicated that Snn5-B1 was predominant among common wheat accessions whereas Snn5-B2 appeared to be relatively more frequent among durum lines. This research extends our knowledge of the Snn5-SnTox5 interaction and the wheat-P. nodorum system in general, and provides tools to aid in the development of SNB-resistant wheat via marker-assisted selection and gene editing.",
    citingPapers: []
  },
  {
